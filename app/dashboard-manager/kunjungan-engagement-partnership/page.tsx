    ...
    <>
      <div className="flex-1 space-y-4 sm:space-y-6 p-4 sm:p-8 pt-6 pb-20 sm:pb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Kunjungan Engagement Partnership</h2>
            <p className="text-sm sm:text-base text-muted-foreground">
              Catat dan kelola kunjungan engagement partnership per bulan
            </p>
          </div>
