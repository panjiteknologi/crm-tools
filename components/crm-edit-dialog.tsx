...
import { Save, X, Building2, Users, FileText, DollarSign, Calendar } from 'lucide-react';
  ...
  const handleUpdate = async () => {
    ...
    try {
      await updateTargetMutation({
        ...
        hargaKontrak: formData.hargaKontrak ? parseFloat(cleanNumber(formData.hargaKontrak)) : undefined,
        bulanTtdNotif: formData.bulanTtdNotif || undefined,
        hargaTerupdate: formData.hargaTerupdate ? parseFloat(cleanNumber(formData.hargaTerupdate)) : undefined,
        ...
        cashback: formData.cashback ? parseFloat(cleanNumber(formData.cashback)) : undefined,
      ...
      toast.success('✅ CRM Target berhasil diperbarui!');
      onOpenChange(false);
      onSuccess?.();
    } catch (error) {
      toast.error('❌ Gagal memperbarui CRM Target');
      console.error(error);
    }
  };
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <Select value={formData.status || undefined} onValueChange={(value) => updateFormField('status', value)}>
                        <SelectTrigger className="border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-emerald-500 h-9 text-sm">
                          <SelectValue placeholder="Pilih" />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="space-y-1">
                      ...
                      <Select value={formData.tahun || undefined} onValueChange={(value) => updateFormField('tahun', value)}>
                        <SelectTrigger className="border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-purple-500 h-9 text-sm">
                          <SelectValue placeholder="Pilih" />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <Select value={formData.terminPembayaran || undefined} onValueChange={(value) => updateFormField('terminPembayaran', value)}>
                          <SelectTrigger className="border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-green-500 h-9 text-sm">
                            <SelectValue placeholder="Pilih" />
                          </SelectTrigger>
                          <SelectContent>
